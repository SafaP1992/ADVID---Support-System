                ...
                <form method="POST" id="comment_form">
                    ...
                    <div class="col-12 my-5">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="text-left">
                                    <a class="btn btn-primary text-left" href="fetch-user-comments.php">بازگشت</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <input type="hidden" name="res_id_user" id="res_id_user" value="">
