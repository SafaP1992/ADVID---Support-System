...
try {
    ...
    if ($number_of_rows > 0) {
        foreach ($q as $row) {
            ...
            // $vcr_date = tr_num($row['vcrSupportDateTime'], 'fa');
            // $array = trim();
            // $jalali_date = jdate("Y/m/d", $timestamp);
            // $jalali_time = jdate("H:i:s", $timestamp);
            ...
            if ($priority == 1) {
                $priority_str = '<div class="alert bg-info text-white text-center p-1" style="font-size:10px; padding:0">کم</div>';
            } elseif ($priority == 2) {
                $priority_str = '<div class="alert bg-dark text-white text-center p-1" style="font-size:10px; padding:0">متوسط</div>';
            } elseif ($priority == 3) {
                $priority_str = '<div class="alert bg-warning text-center p-1" style="font-size:10px; padding:0">زیاد</div>';
            } elseif ($priority == 4) {
                $priority_str = '<div class="alert bg-danger text-white text-center p-1" style="font-size:10px; padding:0">اورژانسی</div>';
            }
            ...
            <div class="row">
                <div class="col-6">
                    <h4 class="mb-4">پاسخ درخواست</h4>
                </div>
                <div class="col-6">
                    <div class="text-left bar-code"><svg id="barcode"  viewBox="0 0 240 100"></svg></div>            
                </div>  
            </div>  
            ...
            <div class="col-md-12">
                ...
                <div class="row m-1">
                    <div class="col-12 col-sm-8">
                        <div class="alert p-1 m-0" style="font-size:10px; text-align:center; background-color:#f4e9c8 !important;">' . $gender_str . ' ' . $row['vcrUserRelName'] . '، واحد ' . $row['vcrUserRelSection'] . '، شماره تماس:' . $row['vcrUserRelContact'] . '</div> 
                    </div>
